...
#---------------------------------
#
#    Joy Nelson 11/21/2013
#    Modified to work with new table structure related to accounts rewrite by Kyle Hall, BWS for 3.16
#      accountlines deprecated and account_credits and account_debits used in it's place.
#
#---------------------------------
...
while (my $line=$csv->getline($io)){
   ...
   my @data = @$line;
   my $querystr = "INSERT INTO account_debits (";
   my $exception = 0;
