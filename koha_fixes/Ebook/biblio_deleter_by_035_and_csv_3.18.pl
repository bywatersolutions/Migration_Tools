...
#print "This is my tag $tag. \n";

#edited by Dani
#my $final_tag = substr($tag,7) if (length($tag) > 10);

#print "This is the final tag $final_tag \n";

my $final_tag = $tag;

#print "This is the final tag $final_tag for biblionumber= $bibnum \n"; 

 if ($final_tag) {
print "in the file: $final_tag and $ebooks{$final_tag}\n" if (exists $ebooks{$final_tag});
