...
#---------------------------------
#
# Kyle updated the script to ignore pre-existing RDA tags and continue loading 2016-02-04
#
#---------------------------------
...
my $j=0;
my $sth1=$dbh->prepare("insert ignore into marc_tag_structure (tagfield, liblibrarian, libopac, repeatable, mandatory, frameworkcode) values 
         ...
         (384,'KEY','KEY',0,0,?)");
my $sth2=$dbh->prepare("insert ignore into marc_subfield_structure (tagfield, tagsubfield, liblibrarian, libopac, repeatable, mandatory, tab, isurl, hidden, frameworkcode) values 
